...
import 'package:hi_doctor_v2/app/modules/appointment/views/check_in_page.dart';
...
import 'package:hi_doctor_v2/app/modules/home/views/doctor_spec_page.dart';
...
abstract class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: Routes.CONTRACT_SCHEDULE,
      page: () => SchedulePage(),
    ).custom(),
    GetPage(
      name: Routes.CONTRACT_RECORDS,
      page: () => RecordsPage(),
    ).custom(),
    GetPage(
      name: Routes.DOCTOR_SPEC,
      page: () => DoctorBySpecPage(),
    ).custom(),
  ];
}
