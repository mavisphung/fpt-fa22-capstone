...
class ReccommendHrExtendableRow extends StatefulWidget {
  ...
  const ReccommendHrExtendableRow({super.key, required this.map, required this.instructionType});
...
class _ReccommendHrExtendableRowState extends State<ReccommendHrExtendableRow> {
  ...
  // var _isChosenList = <bool>[];

  @override
  Widget build(BuildContext context) {
    final list1 = widget.map['instructions'] as List?;
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Tạo ngày ${Utils.reverseDate(widget.map["record"]["createdAt"])}',
                      style: TextStyle(
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: NetworkImage(e['info']['content']),
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
                      const SizedBox(width: 10),
                      Expanded(child: Text(widget.instructionType)),
                      Checkbox(
