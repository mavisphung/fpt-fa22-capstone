...
import 'package:hi_doctor_v2/app/modules/contract/contract_step4.dart';
...
class _CreateContractPageState extends State<CreateContractPage> {
  ...
  final List<Widget> _step = [ContractStep1(), ContractStep2(), ContractStep3(), ContractStep4()];
          ...
          children: [
            ...
            ObxValue<Rx<Status>>(
              (data) => CustomElevatedButtonWidget(
                textChild: _currentStep == 3 ? 'Gửi yêu cầu' : Strings.kContinue,
                status: data.value,
