          ...
          children: [
                      ...
                      children: [
                        ...
                        ContentRow(
                          ...
                          content: {
                            ...
                            Strings.age: Tx.getAge(Utils.reverseDate(patient.dob)),
            ...
            CustomContainer(
              child: ContentRow(
                ...
                verPadding: 0,
                content: {
                  'Ngày hẹn': DateFormat('yyyy-MM-dd').format(_cBooking.selectedDate),
                  'Giờ bắt đầu': _cBooking.selectedTime,
                  'Thời gian tối đa cho cuộc hẹn': '30 phút',
                  'Loại cuộc hẹn': servicePackage.category.toString().enumType.label,
                  Strings.package: servicePackage.name!,
                  'Mô tả': servicePackage.description!,
                  Strings.price: '${Tx.formatPrice(servicePackage.price!)} VNĐ',
                },
                labelWidth: 120,
              ),
            ),
