            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  PatientTile(
                    patient: Patient(firstName: 'Thêm hồ sơ bệnh nhân', lastName: ''),
                    textStyle: TextStyle(color: AppColors.primary),
                    onTap: (_) => Get.toNamed(Routes.PATIENT_PROFILE_DETAIL),
                  ),
                  Padding(
                    ...
                    child: Text(
                      'Hệ thống sẽ tải thông tin của bệnh nhân đã chọn.',
