...
abstract class Utils {
  ...
  static String getPaymentUrl({required double amount, required String orderInfo}) {
    ...
    final paymentUrl = VNPAYFlutter.instance.generatePaymentUrl(
      ...
      orderInfo: 'Thanh toan tien dat hen $amount VNĐ', //order info, default is Pay Order
      amount: amount,
      ...
      vnPayHashType: VNPayConfig
          .hashKeyType, //hash type. Default is HmacSHA512, you can chang it in: https://sandbox.vnpayment.vn/merchantv2
    );
    return paymentUrl;
  }
