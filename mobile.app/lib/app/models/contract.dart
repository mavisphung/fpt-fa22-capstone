...
class Contract {
  ...
  factory Contract.fromMap(Map<String, dynamic> map) {
    return Contract(
      ...
      map['startedAt'] != null ? map['startedAt'] as String : null,
  ...
  @override
  String toString() {
    return 'Contract(id: $id, startedTime: $startedAt, endedAt: $endedAt, price: $price, status: $status, doctor: $doctor, patient: $patient, supervisor: $supervisor, healthRecord: $healthRecord, order: $order, service: $service)';
  }
}
